...
public class ThreadLocal<T> {
    ...
    public T get() {
        ...
        if (map != null) {
            // 通过this对象(ThreadLocal)获取ThreadLocalMap.Entry对象
    ...
    static class ThreadLocalMap {
        ...
        private Entry getEntry(ThreadLocal<?> key) {
            ...
            if (e != null && e.get() == key)
                ...
                // 继续寻找下一个位置 注意这里会清除key为null的value值
        ...
        private Entry getEntryAfterMiss(ThreadLocal<?> key, int i, Entry e) {
            ...
            while (e != null) {
                ...
                if (k == key)
                    return e;
                // 注意key为空时，这里会清除旧的value的值，防止内存泄漏，但是如果一直不能被清除就有可能发生内存泄漏
                if (k == null)
                    // 清除旧的value
                    expungeStaleEntry(i);
                else
        ...
        private void set(ThreadLocal<?> key, Object value) {
            ...
            // 如果当前位置上无元素，则直接初始化一个Entry放在对应的位置上
